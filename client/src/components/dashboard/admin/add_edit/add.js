...
import {productsAdd } from 'store/actions/product.action'
import {clearProductsAdd} from 'store/actions/index'
                        ...
                        <div className="form-group mt-4">
                            <FormControl variant="outlined">
                                ...
                                <Select
                                    ...
                                    errors={formik.errors.brand && formik.touched.brand ? true : false}
                                >
                                    <MenuItem value="">
                                        <em>None</em>
                                    </MenuItem>
                        ...
                        <div className="form-group mt-4">
                            <FormControl variant="outlined">
                                ...
                                <Select
                                    ...
                                    errors={formik.errors.shipping && formik.touched.shipping ? true : false}
                                >
                                    <MenuItem
                                        value={true}
                                    > Yes
